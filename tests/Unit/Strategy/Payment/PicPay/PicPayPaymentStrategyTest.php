...
use Rodineiti\SmartfastpaySdk\Strategy\Payment\PicPay\PicPayParams;
use Rodineiti\SmartfastpaySdk\Strategy\Payment\PicPay\PicPayPaymentStrategy;

class PicPayPaymentStrategyTest extends TestCase
{
    public function testPicPayPaymentProcess()
    {
        ...
        $paymentStrategy = new PicPayPaymentStrategy();
